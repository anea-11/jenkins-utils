...
class GlobalVars {
    ...
    public static String NEXUS_URL = 'http://18.156.155.64:8081/repository/encoder-app-snapshot/';
    ...
    public static String DOCKERHUB_CREDENTIALS_ID = 'dockerhub_credentials';
    ...
    public static String ENCODER_APP_GITHUB_URL = 'https://github.com/anea-11/x265'
